...
namespace AidenHelper.Code.Entities
{
    [CustomEntity("AidenHelper/PlatformSupportedFallingBlock")]
    [Tracked(false)]
    class PlatformSupportedFallingBlock : Solid
    {
		...
		private bool actorRiding { get; set; }

		public bool HasStartedFalling { get; private set; }

		public PlatformSupportedFallingBlock(Vector2 position, char tile, int width, int height, bool finalBoss, bool behind, bool climbFall)
		...
		public PlatformSupportedFallingBlock(EntityData data, Vector2 offset)
